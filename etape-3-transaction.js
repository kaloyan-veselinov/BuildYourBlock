...
const {Transaction, Input, Output, buildSimpleTransaction, calculateWallet} = require("./Transaction")
...
console.log("Send1000AliceToBob :", Send1000AliceToBob);
...
console.log("Combien de BYB a Alice ?");
console.log(calculateWallet(unspentOutputs, PUBLIC_KEY_ALICE));

console.log("Combien de BYB a Bob ?");
console.log(calculateWallet(unspentOutputs, PUBLIC_KEY_BOB));
